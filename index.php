<!DOCTYPE html>
    ...
    <head>
        ...
        <title>Undead Wars | Play2Earn | MMORPG Game</title>
    </head>
    <body>
        <!--==================== HEADER ====================-->
            ...
            <nav class="nav container">
                ...
                <div class="nav__menu" id="nav-menu">
                    <ul class="nav__list">                     
                        ...
                        <a href="#" class="button button--ghost">Launch App</a>
                    </ul>
        ...
        <main class="main">
                            ...
                            <div class="home__content grid">
                                <div class="home__group">
                                    ...
                                    <div class="home__details-img">
                                        <h4 class="home__details-title">The Warrior “Chikueltan</h4>
                                        <span class="home__details-subtitle">The Deaht Fighter</span>
                                    </div>
                                </div>
    
                                <div class="home__data">
                                    <h3 class="home__subtitle">#1 2D MMORPG Game</h3>
                                    <h1 class="home__title">PLAY<br> EARN <br> TREAT!!</h1>
                                    ...
                                    <div class="home__buttons">
                                        ...
                                        <a href="#" class="button--link button--flex">See On Market <i class='bx bx-right-arrow-alt button__icon'></i></a>
                                    </div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section class="swiper-slide">
                            <div class="home__content grid">
                                <div class="home__group">
                                    ...
                                    <div class="home__details-img">
                                        <h4 class="home__details-title">The Archer "Kukuleta"</h4>
                                        <span class="home__details-subtitle">No words can describe them</span>
                                    </div>
                                </div>
    
                                <div class="home__data">
                                    <h3 class="home__subtitle">#2 Play AnyWhere</h3>
                                    <h1 class="home__title">PC <br>MOBILE <br> WEB</h1>
                                    ...
                                    <div class="home__buttons">
                                        <a href="#" class="button">Play Now</a>
                                        <a href="#" class="button--link button--flex">See All Platform <i class='bx bx-right-arrow-alt button__icon'></i></a>
                                    </div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section class="swiper-slide">
                            <div class="home__content grid">
                                <div class="home__group">
                                    ...
                                    <div class="home__details-img">
                                        <h4 class="home__details-title">The Mage "Fyorjall</h4>
                                        <span class="home__details-subtitle">From Death to Death</span>
                                    </div>
                                </div>
    
                                <div class="home__data">
                                    <h3 class="home__subtitle">#3 Guild Wars</h3>
                                    <h1 class="home__title">TEAM <br> WARS <br> FOR EARN</h1>
                                    ...
                                    <div class="home__buttons">
                                        <a href="#" class="button">Play Now</a>
                                        <a href="#" class="button--link button--flex">See Leaderboard<i class='bx bx-right-arrow-alt button__icon'></i></a>
                                    </div>
                                </div>
                            </div>
                        </section>
               ...
               <section class="section about" id="about">
                <div class="about__container container grid">
                    <div class="about__data">
                        <h2 class="section__title about__title">About Undead <br> Wars</h2>
            ...
            <h2 class="section__title"> Our <br> Roadmap</h2>
